...
```text
breadcrumbs.ai/
├── starter/                 # Student Codebase Skeleton
│   ├── app/                 # FastAPI core models, prompts, and server template
...
│
├── slides/                  # Interactive Local Slide Deck
│   └── index.html           # Full-viewport dark theme slideshow with 3D particle background
│
